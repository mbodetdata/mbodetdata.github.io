...
Le coût invisible, c’est tout le reste :
...
3. Quel fonctionnement bloque dès qu’une personne manque ou qu’un fichier est introuvable ?
4. Quel point ralentit le plus le suivi de l’activité ou la prise de décision ?

Ensuite, classez vos sujets selon une logique simple :
la fréquence,
le temps perdu,
