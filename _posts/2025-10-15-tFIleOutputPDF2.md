...
**→ [Projet d’exemple tFileOutputPDF2 sur GitHub](https://github.com/<ton-user>/talend-tfileoutputpdf2-demo)**  
(*Job Talend complet, composants, expressions, et capture du résultat PDF.*)

Vous pouvez l’importer directement dans Talend ou Talaxie pour tester la configuration en quelques clics.
