...
(function () {
  ...
  var STAR_SVG =
    '<svg viewBox="0 0 20 20" fill="#f59e0b" aria-hidden="true">' +
  ...
  function createBanner() {
    ...
    banner.setAttribute('aria-label', 'Installer l\'application BM Data');
    banner.innerHTML =
      '<div class="pwa-inner">' +
        '<div class="pwa-header">' +
          '<span class="pwa-badge">Application gratuite</span>' +
        ...
        '<div class="pwa-identity">' +
          ...
          '<div class="pwa-app-info">' +
            '<div class="pwa-app-name">BM Data</div>' +
            '<div class="pwa-app-desc">Conseil en données pour TPE/PME</div>' +
          '</div>' +
        '</div>' +
        '<div class="pwa-stars" aria-label="Note : 5 étoiles">' +
          '<div class="pwa-stars-icons">' +
            STAR_SVG + STAR_SVG + STAR_SVG + STAR_SVG + STAR_SVG +
          '</div>' +
          '<span class="pwa-stars-label">Accès instantané</span>' +
        '</div>' +
        '<button id="pwa-install-btn" class="pwa-install-btn">' +
          '<span class="pwa-install-btn-inner">' +
            '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 15V3m0 12-4-4m4 4 4-4"/><path d="M2 17l.621 2.485A2 2 0 0 0 4.561 21h14.878a2 2 0 0 0 1.94-1.515L22 17"/></svg>' +
            'Installer l\'application' +
          '</span>' +
        '</button>' +
        '<p class="pwa-free-note">Gratuit &middot; Aucun store requis &middot; Hors ligne disponible</p>' +
      '</div>';
